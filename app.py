...
# ------------------ TASKS ------------------
    ...
    with tab1:
        ...
        if st.button("Add Task", type="primary"):
            TaskService.create_task(title, description, deadline=deadline or None)
...
# ------------------ ASSIGNMENTS ------------------
    ...
    task_id2 = st.number_input("Task ID (for status update)", min_value=1, step=1, key="update_status")
